...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var RECENT_DAYS = 30;
    var WEEK_DAYS = 7;
    function windowFromDays(days, nDays) {
    ...
    function KpiCards({ summary, coverage, i18n }) {
      const t = i18n.t;
    ...
    function BarChart({ days, byModel, i18n, onTip }) {
      ...
      const rangeDays2 = days;
      const yMax = niceCeil(Math.max.apply(null, rangeDays2.map((d) => d.total).concat(1)));
      const W = 720;
      const H = 230;
      const PL = 52;
      const PR = 12;
      ...
      return /* @__PURE__ */ React4.createElement("div", { className: "dsw-ust-card" }, /* @__PURE__ */ React4.createElement("div", { className: "dsw-ust-card-head" }, /* @__PURE__ */ React4.createElement("div", { className: "dsw-ust-card-title" }, /* @__PURE__ */ React4.createElement("h3", null, t("bar.title")), /* @__PURE__ */ React4.createElement("span", { className: "dsw-ust-card-sub" }, t("bar.sub")))), /* @__PURE__ */ React4.createElement("svg", { viewBox: "0 0 720 230", className: "dsw-ust-chart", preserveAspectRatio: "xMidYMid meet" }, yLines, bars, xLabels), /* @__PURE__ */ React4.createElement("div", { className: "dsw-ust-legend" }, rows.map((r) => /* @__PURE__ */ React4.createElement("span", { key: r.model, className: "dsw-ust-legend-item" }, /* @__PURE__ */ React4.createElement("i", { style: { background: r.rest ? "var(--dsw-alias-label-secondary)" : r.color, opacity: r.rest ? 0.45 : 1 } }), r.model))));
    }
    ...
    function summarizeRange(data, range) {
      ...
      const sessionCount = range === "7d" ? typeof data.weekSessionCount === "number" ? data.weekSessionCount : data.sessionCount : data.sessionCount;
      return { totals: w.totals, byModel: w.byModel, sessionCount };
    }
    function providersFor(data, range) {
      if (range === "7d") return data.week.providers;
      if (range === "all") return data.allTime.providers;
      return data.providers;
    }
    function rangeDays(data, range) {
    ...
    function StatsSection({ rpc, i18n: baseI18n }) {
      ...
      const [freshness, setFreshness] = (0, import_react3.useState)("loading");
      const [barTip, setBarTip] = (0, import_react3.useState)(null);
      const [donutTip, setDonutTip] = (0, import_react3.useState)(null);
      const [heatTip, setHeatTip] = (0, import_react3.useState)(null);
      const [range, setRange] = (0, import_react3.useState)(RANGE_DEFAULT);
      ...
      const summary = (0, import_react3.useMemo)(() => data ? summarizeRange(data, range) : null, [data, range]);
      const barDays = (0, import_react3.useMemo)(() => data ? rangeDays(data, range) : [], [data, range]);
      let subText = null;
      ...
      if (!data && !error) {
        ...
        const overview = data;
        const sum = summary;
        body = /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement(KpiCards, { summary: sum, coverage: overview.coverage, i18n }), /* @__PURE__ */ React9.createElement(Heatmap, { days, i18n, onTip: setHeatTip }), /* @__PURE__ */ React9.createElement(BarChart, { days: barDays, byModel: sum.byModel, i18n, onTip: setBarTip }), /* @__PURE__ */ React9.createElement(SessionsCard, { sessions: overview.topSessions, i18n }), /* @__PURE__ */ React9.createElement(ProvidersCard, { providers: providersFor(overview, range), i18n }), /* @__PURE__ */ React9.createElement(ModelDonut, { byModel: sum.byModel, total: sum.totals.total, i18n, onTip: setDonutTip }));
      }
      ...
      ))), data ? /* @__PURE__ */ React9.createElement("div", { className: "dsw-ust-capsule", role: "group", "aria-label": t("nav.label") }, ["7d", "30d", "all"].map((r) => /* @__PURE__ */ React9.createElement(
        "button",
        {
          key: r,
          type: "button",
    ...
    var Boundary = class extends import_react4.Component {
      state = { error: null };
    ...
    function apply(ctx) {
      ...
      slots.inject(
        ...
        () => slots.register(
          ...
          () => (0, import_react5.createElement)(Boundary, { i18n }, (0, import_react5.createElement)(StatsSection, { rpc: ctx.connection.rpc, i18n }))
        )
      );
      ctx.effect(() => () => {
