...
var PROJECTION_STATE_VERSION = 6;
...
async function listPersistenceRevisions(persistence, logFailure) {
  const result = /* @__PURE__ */ new Map();
  if (!persistence) return result;
  try {
    const snapshots = typeof persistence.list === "function" ? await persistence.list() : typeof persistence.listSnapshots === "function" ? await persistence.listSnapshots() : [];
